...
Future<List<LegendarySetDataModel>> fetchLegendarySets() async {
  ...
  if (response.statusCode == 200) {
    ...
    return LegendarySetDataModel.fromJson(jsonDecode(response.body)) as List<LegendarySetDataModel>;
  } else {
